      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-16">
        <div className="text-center max-w-3xl mx-auto space-y-4">
          ...
          <h1 className="text-4xl sm:text-5xl font-extrabold tracking-tight">
            Majnoon at {cinemaName}
          </h1>
          <p className="text-muted-foreground text-base leading-relaxed">
            {brandName} presents the film Majnoon. Choose any open showtime,
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="flex flex-col justify-center space-y-4 p-2">
            ...
            <ul className="text-sm text-muted-foreground space-y-2 list-disc pl-5">
              ...
              <li>Submit reservation — we will contact as soon as the reservation is confirmed</li>
