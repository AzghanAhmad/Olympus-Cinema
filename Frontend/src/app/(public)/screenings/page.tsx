      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-8">
        <div>
          ...
          <p className="text-muted-foreground text-sm mt-1">
            {cinemaName} · Pick any open show and reserve up to {maxTickets} seats. Booking is confirmed after payment.
          </p>
        </div>
          ...
          {screenings.map((scr) => (
            ...
            >
              <div className="flex items-center gap-4 w-full md:w-auto">
                ...
                <div>
                  <h3 className="font-extrabold text-lg">{MAJNOON.title}</h3>
                  <p className="text-xs text-muted-foreground mt-1">{cinemaName}</p>
